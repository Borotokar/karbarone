  ...
  void initState() {
    ...
    try {
      final config = AdTraceConfig(
        ...
        AdTraceEnvironment
            .sandbox, // یا AdTraceEnvironment.production برای نسخه نهایی
      );
      ...
      config.attributionCallback = (AdTraceAttribution attributionChangedData) {
        ...
        if (attributionChangedData.clickLabel != null) {
          Get.log(
            '[AdTrace]: Click label: ' + attributionChangedData.clickLabel!,
          );
        }
    ...
    return GetMaterialApp(
      builder: (context, child) {
        return MediaQuery(
          data: MediaQuery.of(
            context,
          ).copyWith(textScaleFactor: 0.8), // ثابت کردن سایز متن
          child: child!,
        );
      },
      title: 'borotokar',
      ...
      initialBinding: BindingsBuilder(() async {
        ...
        Get.put(OrderServiceController(), permanent: true);
